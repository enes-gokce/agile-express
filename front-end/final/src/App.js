    ...
    <div className="App">
      {(user.username !== "*") ? (
          <Routes>
            ...
            <Route path='/project/:id' element={<Board Logout={Logout} user={user} token={token} />} />
            <Route path='/search/:inputQuery/*' element={<Search Logout={Logout} user={user} token={token} />} />
          </Routes>
      ) : (
          <div className="App">
